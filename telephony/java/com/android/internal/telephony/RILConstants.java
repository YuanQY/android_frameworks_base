...
*/
    ...
    int RIL_REQUEST_MOBILEREVISION_AND_IMEI = RIL_REQUEST_MTK_BASE + 18;
    ...
    int RIL_REQUEST_VOICE_ACCEPT = RIL_REQUEST_MTK_BASE + 23;
    int RIL_REQUEST_BTSIM_CONNECT = RIL_REQUEST_MTK_BASE + 24;
    int RIL_REQUEST_BTSIM_DISCONNECT_OR_POWEROFF = RIL_REQUEST_MTK_BASE + 25;
    int RIL_REQUEST_BTSIM_POWERON_OR_RESETSIM = RIL_REQUEST_MTK_BASE + 26;
    int RIL_REQUEST_BTSIM_TRANSFERAPDU = RIL_REQUEST_MTK_BASE + 27;
    int RIL_REQUEST_EMERGENCY_DIAL = RIL_REQUEST_MTK_BASE + 28;
    int RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_ACT = RIL_REQUEST_MTK_BASE + 29;
    int RIL_REQUEST_QUERY_ICCID = RIL_REQUEST_MTK_BASE + 30;
    int RIL_REQUEST_SIM_AUTHENTICATION = RIL_REQUEST_MTK_BASE + 31;
    int RIL_REQUEST_USIM_AUTHENTICATION = RIL_REQUEST_MTK_BASE + 32;
    ...
    int RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_SW = RIL_REQUEST_MTK_BASE + 74;
    int RIL_REQUEST_SET_CLIP = RIL_REQUEST_MTK_BASE + 75;
    int RIL_REQUEST_UICC_SELECT_APPLICATION = RIL_REQUEST_MTK_BASE + 76;
    int RIL_REQUEST_UICC_DEACTIVATE_APPLICATION = RIL_REQUEST_MTK_BASE + 77;
    int RIL_REQUEST_UICC_APPLICATION_IO = RIL_REQUEST_MTK_BASE + 78;
    int RIL_REQUEST_UICC_AKA_AUTHENTICATE = RIL_REQUEST_MTK_BASE + 79;
    int RIL_REQUEST_UICC_GBA_AUTHENTICATE_BOOTSTRAP = RIL_REQUEST_MTK_BASE + 80;
    int RIL_REQUEST_UICC_GBA_AUTHENTICATE_NAF = RIL_REQUEST_MTK_BASE + 81;
    int RIL_REQUEST_STK_EVDL_CALL_BY_AP = RIL_REQUEST_MTK_BASE + 82;
    int RIL_REQUEST_SWITCH_HOLDING_AND_ACTIVE = RIL_REQUEST_MTK_BASE + 83;
    int RIL_REQUEST_GSM_GET_BROADCAST_SMS_CONFIG = RIL_REQUEST_MTK_BASE + 84;
    int RIL_REQUEST_GSM_SET_BROADCAST_SMS_CONFIG = RIL_REQUEST_MTK_BASE + 85;
    int RIL_REQUEST_GSM_SMS_BROADCAST_ACTIVATION = RIL_REQUEST_MTK_BASE + 86;
    int RIL_REQUEST_CDMA_GET_BROADCAST_SMS_CONFIG = RIL_REQUEST_MTK_BASE + 87;
    int RIL_REQUEST_CDMA_SET_BROADCAST_SMS_CONFIG = RIL_REQUEST_MTK_BASE + 88;
    int RIL_REQUEST_CDMA_SMS_BROADCAST_ACTIVATION = RIL_REQUEST_MTK_BASE + 89;
    ...
    int RIL_UNSOL_CNAP = RIL_UNSOL_MTK_BASE + 30;
    int RIL_UNSOL_STK_EVDL_CALL = RIL_UNSOL_MTK_BASE + 31;
